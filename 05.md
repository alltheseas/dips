...
Nostr today is like a large bitcoin meetup. Bitcoiners find it easy to find their people and join in on the conversation by default. However, for *non*-bitcoiners, it is not trivial to find interesting people to follow or conversations to join in.
...
This can be a major roadblock for adoption of public-square/Twitter-style/`kind:1` clients outside Bitcoiner circles.
...
### Community Subscriptions
  ...
  Users track which communities they've subscribed to using a dedicated event `kind:10073`.
...
Privacy
  ...
  On Login:
  1. Fetch kind:10073 event for the user's pubkey
  ...
  2. Publish updated kind:10073 event
  3. Being a replaceable event, only the latest version is kept
